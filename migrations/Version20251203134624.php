 ...
 */
final class Version20251203134624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation CHANGE playlist_id playlist_id INT NOT NULL, CHANGE published_at published_at DATETIME NOT NULL, CHANGE title title VARCHAR(100) NOT NULL, CHANGE video_id video_id VARCHAR(20) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation CHANGE playlist_id playlist_id INT DEFAULT NULL, CHANGE published_at published_at DATETIME DEFAULT NULL, CHANGE title title VARCHAR(100) DEFAULT NULL, CHANGE video_id video_id VARCHAR(20) DEFAULT NULL');
    }
}
